...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="tree.BaseTreeNode",
                    ),
                ),
                ("opening_title", models.CharField(max_length=200, verbose_name="Opening title")),
                (
                    "opening_image",
                    models.ImageField(upload_to="images", null=True, verbose_name="Opening image", blank=True),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="parent",
            field=polymorphic_tree.models.PolymorphicTreeForeignKey(
                related_name="children", verbose_name="parent", blank=True, to="tree.BaseTreeNode", null=True
            ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.CASCADE,
                related_name=b"polymorphic_tree.basetreenode_set+",
                editable=False,
